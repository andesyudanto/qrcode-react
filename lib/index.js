...
class QRCode extends React.Component {
    ...
    update() {
        ...
        if (this.props.text) {
            var fontHeight = this.props.textHeight || 20;

            canvas.height = canvas.height + fontHeight;
            canvas.font = this.props.textFont || '48px serif';
            canvas.textAlign = 'center';
            canvas.fillText(this.props.text, this.props.size / 2, fontHeight);
        }
    }
